...
public class SoundManager : MonoBehaviour
{
    ...
    private Dictionary<BGM, AudioClip> bgm = new Dictionary<BGM, AudioClip>();
    private Dictionary<Effect, AudioClip> effect = new Dictionary<Effect, AudioClip>();
    private Dictionary<CharacterType, AudioClip> characterVoice = new Dictionary<CharacterType, AudioClip>();
    ...
    public void LoadSound()//사운드 추가하는곳
    {
        ...
        foreach(var type in System.Enum.GetValues(typeof(CharacterType)))
        {
            CharacterType convertedType = (CharacterType)type;
            characterVoice.Add(convertedType, Resources.Load("Sound/Character/(SFX)DeongeonCatHeroes_CharacterSound_" + convertedType.ToString()) as AudioClip);
        }
        #endregion
    }
    ...
    public void PlayCharacterVoice(CharacterType type)
    {
        EffectSource.PlayOneShot(characterVoice[type]);
    }
}
